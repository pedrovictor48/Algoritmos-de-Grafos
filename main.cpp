...
void help() {
    ...
    cout << "os valores padrões são 0 para o vértice inicial e final, grafo.txt para o grafo de entrada e out.txt para a saída\n";
}
...
int main(int argc, char ** argv) {
    ...
    //cout << HELP << " " << SOL << " " << START << " " << LAST << " " << IN << " " << OUT << endl;
    if(HELP) help();
